...
<head> 
    ...
    <!-- Primary Meta Tags -->
    <title> ฟาร์มโชคชัย Drive Thru </title>
    <meta name="title" content="CHOKCHAISTEAK.DRIVETHRU">
...
<body class="custom-background">
    <header class=""> 
        <!-- //==========NAV===========// -->
        <nav class="navbar navbar-expand-lg navbar-custom navbar-dark borderBottom-nav" style="padding: .5rem 1rem .2rem 0.1rem;"> 
            <div class="container">    
                <div class="d-flex">
                    <div>
                        <a class="navbar-brand logo" href="{{ route('home') }}" class="">  
                            <div class="ml-2" style="color: #333"> ฟาร์มโชคชัย <span style="color: #E89E5E;font-size: 13px;"> DRIVE THRU </span> </div>
                        </a> 
                    </div>   
                </div>  
                <div class="d-flex justify-content-end">  
                    ...
                    @else
                        ...
                        <div class="ml-4">
                            <a href="{{ route('order') }}">   
                                <span class="d-block d-sm-none text-center" style="line-height: 1.3;">
                                    <i class="fe-clock" style="font-size: 25px;"></i>
                                    <div style="font-size: 8px;">คำสั่งซื้อ</div>
                                </span>
                                <span class="d-none d-sm-block"><i class="fe-clock" style="font-size: 25px;"></i> คำสั่งซื้อ </span> 
                            </a>      
                        </div> 
                        <div class="ml-4">
                            <a href="{{ route('profile') }}">  
                                <span class="d-block d-sm-none text-center" style="line-height: 1.3;">
                                    <i class="fe-user" style="font-size: 25px;"></i>
                                    <div style="font-size: 8px;">โปรไฟล์</div>
                                </span>
                                <span class="d-none d-sm-block"><i class="fe-user" style="font-size: 25px;"></i> โปรไฟล์ </span> 
                            </a>      
                        </div>
